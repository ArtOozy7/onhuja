function predictPCOS(selectedSymptoms) {
  ...
  console.log("High Likelihood:", highLikelihood);
  console.log("Medium Likelihood:", mediumLikelihood);
  console.log("Low Likelihood:", lowLikelihood);
  console.log("None Likelihood:", noneLikelihood);
